...
char pices[BLOCKS * 4][10] = {"W_R-1", "W_H-1", "W_B-1", " W_Q ", " W_K ", "W_B-2", "W_H-2", "W_R-2 ", " W_S ", " W_S ", " W_S ", " W_S ", " W_S ", " W_S ", " W_S ", " W_S ", "B_R-1", "B_H-1", "B_B-1", " B_Q ", " B_K ", "B_B-2", "B_H-2", "B_R-2", " B_S ", " B_S ", " B_S ", " B_S ", " B_S ", " B_S ", " B_S ", " B_S "};  // Piece names for display
    ...
    for (int i = 0; i < BLOCKS; i++){
        for (int j = 0; j < BLOCKS; j++){
            ...
            if ((8 <= Board[i][j]) && (Board[i][j] < 16) && (i == 7)){
                ...
                Board[i][j] = (choice == 1) ? 3 : choice == 2 ? 0
                                              : choice == 3   ? 2
                                                              : 1;
            }
